...
object BitgoeulColor : ColorTheme() {
    ...
    override val P9 = Color(0xFFDBECFA)

    override val S1 = Color(0xFF0D4A48)
    ...
    override val S9 = Color(0xFFF2FDFC)

    override val E1 = Color(0xFF4A0D0F)
    ...
    override val E9 = Color(0xFFFdF2F2)

    override val BLACK = Color(0xFF000000)
    override val G1 = Color(0xFF1F1F1F)
    override val G2 = Color(0xFF383838)
    override val G3 = Color(0xFF525252)
    override val G4 = Color(0xFF6B6B6B)
    override val G5 = Color(0xFF858585)
    override val G6 = Color(0xFF9E9E9E)
    override val G7 = Color(0xFFB8B8B8)
    override val G8 = Color(0xFFD1D1D1)
